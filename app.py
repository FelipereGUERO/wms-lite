...
# =========================
...
elif modulo == "Etiquetas / Código de Barras":
    ...
    elif tipo_etiqueta == "Localização":
    ...
    # =========================
    # ETIQUETA DE PEDIDO / ORDEM
    # =========================

    elif tipo_etiqueta == "Pedido / Ordem":
